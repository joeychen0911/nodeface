//JOEY: updated based on node mudule faceplusplus
...
var SDK = function(config) {
	...
	this.attribute = config.attribute;   //JOEY: added attribute configuration
};
...
SDK.prototype.postMulti = function(path, data, callback){
	...
	form.append('attribute', this.attribute);  //JOEY: added attribute configuration
